...
# Watermark text
watermark_text = "Developed by Saurabh Lokhande"

# HTML for watermark
watermark_html = f'<div style="{watermark_style}">{watermark_text}</div>'
...
if selected == 'Diabetes Prediction':
    ...
    if st.button('Diabetes Test Result'):
        ...
        if diab_prediction[0] == 1:
            ...
            st.markdown(f'<span style="color:red">{diab_diagnosis}</span>', unsafe_allow_html=True)
        else:
            diab_diagnosis = 'The person is not diabetic'
            st.markdown(f'<span style="color:green">{diab_diagnosis}</span>', unsafe_allow_html=True)
...
if selected == 'Heart Disease Prediction':
    ...
    if st.button('Heart Disease Test Result'):
        ...
        if heart_prediction[0] == 1:
            ...
            st.markdown(f'<span style="color:red">{heart_diagnosis}</span>', unsafe_allow_html=True)
        else:
            heart_diagnosis = 'The person does not have any heart disease'
            st.markdown(f'<span style="color:green">{heart_diagnosis}</span>', unsafe_allow_html=True)
...
if selected == "Parkinsons Prediction":
    ...
    if st.button("Parkinson's Test Result"):
        ...
        if parkinsons_prediction[0] == 1:
            ...
            st.markdown(f'<span style="color:red">{parkinsons_diagnosis}</span>', unsafe_allow_html=True)
        else:
            parkinsons_diagnosis = "The person does not have Parkinson's disease"
            st.markdown(f'<span style="color:green">{parkinsons_diagnosis}</span>', unsafe_allow_html=True)
...
if selected == "Lungs Cancer Prediction":
    ...
    if st.button("Lung's Test Result"):
        ...
        if lungs_prediction[0] == 1:
            ...
            st.markdown(f'<span style="color:red">{lungs_diagnosis}</span>', unsafe_allow_html=True)
        else:
            lungs_diagnosis = "The person does not have lungs cancer disease"
            st.markdown(f'<span style="color:green">{lungs_diagnosis}</span>', unsafe_allow_html=True)
...
if selected == "Hypo-Thyroid Prediction":
    ...
    if st.button("Thyroid's Test Result"):
        ...
        if thyroid_prediction[0] == 1:
            ...
            st.markdown(f'<span style="color:red">{thyroid_diagnosis}</span>', unsafe_allow_html=True)
        else:
            thyroid_diagnosis = "The person does not have Hypo Thyroid disease"
            st.markdown(f'<span style="color:green">{thyroid_diagnosis}</span>', unsafe_allow_html=True)
